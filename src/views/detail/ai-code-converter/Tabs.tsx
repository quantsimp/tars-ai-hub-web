            ...
            <div className='grid gap-6 md:grid-cols-2'>
              <div>
                <h4 className='text-4xl'>
                  Seamlessly convert code between popular programming languages, such as Python,
                  Java, Kotlin, Swift, Dart, and more, with just a few clicks.
                </h4>
                <Link
                  href='/app/dalle2'
                ...
                >
                  <span className='mr-2'>Try Code-Converter</span>
                  <IoMdArrowForward className='h-5 w-5' />
                </Link>
              </div>
              <div>
                <img
                  src='/images/ai-code-converter/cover.png'
                  alt=''
